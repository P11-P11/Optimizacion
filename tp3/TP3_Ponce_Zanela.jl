...
# ╔═╡ 65f478f4-0ea3-4ed4-a3c4-f865b53c5201
using Random
...
# ╔═╡ 6d71254f-e280-40e1-9a33-01a8cb889e43
md"""# Dada inestabilidad encontrada por el metodo DFP o alguna interaccion con Penalidad / Lagrangiano usamos BFGS implementado por Julia """
...
# ╔═╡ b043e318-3dbe-4245-b646-37ed20971fc5
begin
...
begin
function DFP(f, grad_f, x0; tol=1e-5, max_iter=5_00)
    x_k = x0
    S_k = I(length(x0))
    ...
    println("Reached maximum iterations in DFP")
    return x_k
end
end
...
function penalidad_DFP(f, grad_f, g, grad_g, x0; tol=1e-5, max_iter=500, r=10.0, c=10.0)
    ...
    x_k = x0
    for k in 1:max_iter
        result = DFP(penalizar_f, ∇penalizar_f, x_k)
